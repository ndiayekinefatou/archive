...
data = pd.read_csv('Train_3000.csv')
...
test_dataset = load_dataset('csv',data_files=['SampleSubmission_3000.csv'])



processor = Wav2Vec2Processor.from_pretrained(output_models_dir)
model = Wav2Vec2ForCTC.from_pretrained(f"{output_models_dir}/checkpoint-2400")
model.to("cuda")
...
sub = pd.read_csv('SampleSubmission_3000.csv')
sub.head()
